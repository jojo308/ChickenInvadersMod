...
using ChickenInvadersMod.Common.ItemDropRules.DropConditions;
...
namespace ChickenInvadersMod.Content.NPCs
{
    public class Chicken : BaseChicken
    {
        ...
        public override void ModifyNPCLoot(NPCLoot npcLoot)
        {
            ...
            npcLoot.Add(ItemDropRule.ByCondition(new InSkyCondition(), ModContent.ItemType<SuspiciousLookingFeather>(), 50));

            // Drop item if a Chicken Invasion is active with 0.5% chance  
            npcLoot.Add(ItemDropRule.ByCondition(new ChickenInvasionCondition(), ModContent.ItemType<SuspiciousLookingFeather>(), 200));
            ...
            var foodDropRule = ItemDropRule.Common(ModContent.ItemType<ChickenDrumstick>(), 3, 1, 3);
            foodDropRule.OnFailedRoll(ItemDropRule.Common(ItemID.Burger, 4));
            foodDropRule.OnFailedRoll(ItemDropRule.OneFromOptions(4, ModContent.ItemType<DoubleHamburger>(), ModContent.ItemType<ChickenRoast>()));
