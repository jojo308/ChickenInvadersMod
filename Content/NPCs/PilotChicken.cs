...
namespace ChickenInvadersMod.Content.NPCs
{
    public class PilotChicken : BaseChicken
    {
        ...
        public override void ModifyNPCLoot(NPCLoot npcLoot)
        {
            ...
            var foodDropRule = ItemDropRule.Common(ModContent.ItemType<ChickenDrumstick>(), 5);
            foodDropRule.OnFailedRoll(ItemDropRule.Common(ItemID.Burger, 5));
            foodDropRule.OnFailedRoll(ItemDropRule.OneFromOptions(5, ModContent.ItemType<DoubleHamburger>(), ModContent.ItemType<ChickenRoast>()));
